...
from granuscore.granularity_predictor import GranularityPredictor, LLMGranularityPredictor
...
def compute_hierarchy_features(
    ...
    index_scores = np.array([[i] for i in scorer.score(inputs)])
...
if __name__ == "__main__":
    INDEX_NAME = "llm-gpt-4-1"
    scorer = LLMGranularityPredictor(model_name='gpt-4.1-2025-04-14')
    main(scorer)
